  ...
  return (
    <span
      className={`
        ...
        ${conic ? `${styles.glowConic} bg-glow-conic` : ""}
        ${small ? `${styles.gradientSmall} blur-[32px]` : `${styles.gradientLarge} blur-[75px]`}
        ${className}
      `}
    />
  );
...
export default function Page(): JSX.Element {
  return (
    <main className={`${styles.main || ""} flex min-h-screen flex-col items-center justify-between p-24`}>
      <div className={`${styles.description || ""} z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex`}>
        <p className="fixed px-4 left-0 top-0 flex w-full justify-center border-b bg-gradient-to-b pb-6 pt-8 backdrop-blur-2xl border-neutral-800 bg-zinc-800/30 from-inherit lg:static lg:w-auto lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:bg-zinc-800/30">
          examples -&nbsp;
          <code className={`${styles.code || ""} font-mono font-bold`}>combo css 1</code>
        </p>
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-black via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
          ...
          >
            ...
            <Image
              alt="Vercel Logo"
              className={`${styles.vercellogo || ""} invert`}
              height={24}
              priority
              src="/vercel.svg"
              width={100}
      ...
      <div className={`${styles.hero || ""} relative flex place-items-center`}>
        <div className={`${styles.heroContent || ""} font-sans w-auto pb-16 pt-[48px] md:pb-24 lg:pb-32 md:pt-16 lg:pt-20 flex justify-between gap-8 items-center flex-col relative z-0`}>
          <div className={`${styles.logos || ""} z-50 flex items-center justify-center w-full`}>
            <div className={`${styles.circles || ""} absolute min-w-[614px] min-h-[614px]`}>
              <Image
                alt="Turborepo"
                height={614}
                src="circles.svg"
            ...
            <div className={`${styles.logoGradientContainer || ""} absolute z-50 flex items-center justify-center w-64 h-64`}>
              <Gradient
                className={`${styles.logoGradient || ""} opacity-90 w-[120px] h-[120px]`}
                conic
                small
              />
            </div>

            <div className={`${styles.logo || ""} w-[120px] h-[120px] z-50`}>
              <Image
                alt=""
                height={120}
                priority
          ...
          <Gradient
            className={`${styles.backgroundGradient || ""} top-[-500px] opacity-[0.15] w-[1000px] h-[1000px]`}
            conic
          />
          <div className={`${styles.turborepoWordmarkContainer || ""} z-50 flex flex-col items-center justify-center gap-5 px-6 text-center lg:gap-6`}>
            <svg
              className={`${styles.turborepoWordmark || ""} w-[160px] md:w-[200px] fill-white`}
              viewBox="0 0 506 50"
              width={200}
      ...
      <div className={`${styles.grid || ""} mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left`}>
